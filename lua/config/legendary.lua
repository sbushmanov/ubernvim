...
function M.setup()
  require("legendary").setup({
    ...
    keymaps = {
      ...
      { "ti", ":Telescope lsp_incoming_calls<cr>", description="Telescope lsp incoming calls"},
      { "to", ":Telescope lsp_outgoing_calls<cr>", description="Telescope lsp outgoing calls"},
      ...
      { "tm", ":Telescope lsp_implementations<cr>", description="Telescope implementations"},
      ...
      { "<leader>ld", ":Lspsaga peek_definition<CR>", description = "Lspsaga peek definition" },
      ...
      { "<leader>lD", "<cmd>Lspsaga goto_definition<CR>", description = "Lspsaga go to definition" },
      ...
      { "<leader>lc", "<cmd>Lspsaga show_cursor_diagnostics<CR>", description = "Lspsaga cursor diagnostic" },
      { "<leader>sl", "<cmd>Lspsaga show_line_diagnostics<CR>", description = "Lspsaga line diagnostic" },
      { "<leader>ll", "<cmd>Lspsaga show_line_diagnostics<CR>", description = "Lspsaga line diagnostic" },
      { "<leader>sb", "<cmd>Lspsaga show_buffer_diagnostics<CR>", description = "Lspsaga buffer diagnostic" },
      { "<leader>lb", "<cmd>Lspsaga show_buffer_diagnostics<CR>", description = "Lspsaga buffer diagnostic" },
      ...
      { "<leader>li", "<cmd>Lspsaga incoming_calls<CR>", description = "Lspsaga incoming calls" },
      ...
      { "<leader>lo", "<cmd>Lspsaga outgoing_calls<CR>", description = "Lspsaga outgoing calls" },
